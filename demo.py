...
sparsity = 0.5
print(f"Generating a tensor of size={shape} and precision={dtype} with sparsity={sparsity}\n")
...
print(f"  row_offsets: {sizeof_tensor(bitmask_tensor.row_offsets) / 1024 / 1024:.4f} MB")
